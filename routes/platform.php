...
use App\Orchid\Screens\AttributeScreen;
use App\Orchid\Screens\AttributeEditScreen;
use App\Orchid\Screens\AttributeTypeListScreen;
use App\Orchid\Screens\AttributeTypeEditScreen;
...
Route::screen('products',ProductScreen::class)->name('platform.product.list');
...
Route::screen('attributes',AttributeScreen::class)
->name('platform.attribute.list');

Route::screen('attribute/{attribute?}',AttributeEditScreen::class)
->name('platform.attribute.edit');

Route::screen('attribute-types',AttributeTypeListScreen::class)
->name('platform.attribute-type.list');

Route::screen('attribute-type/{id?}',AttributeTypeEditScreen::class)
->name('platform.attribute-type.edit');